...
<head>
  ...
  <head>
    <title>Lançamentos Online</title>
    <style type="text/css">
    div, p, a, li, td {
 ...
 table td span[class=top-button] {
...
<body style="background-color: #d1d1d1;">
  <table width="100%" bgcolor="#d1d1d1" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
    <tr>
      <td height="54">&nbsp;</td>
    </tr>
  </table>
            ...
            <tr>
              <td><table border="0" cellspacing="0" cellpadding="0" align="left" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                <tr>
                  ...
                  <td height="75" class="inner" valign="middle"><a href="#"><img class="logo" src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/img/logo_lancamentos.png" width="190" height="52" alt="Logo"></a></td>
                </tr>
              </table>
              <table width="280" border="0" cellspacing="0" cellpadding="0" align="right" class="inner" style="border-collapse:collapse; margin-top:7px; height:60px; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                <tr>
                  <td align="center" style="background: #00BFFF; color:#FFF;"><span class="top-button" style="font: bold 20px/40px Arial, Helvetica, sans-serif; line-height: 60px; color: #ffffff; height: 60px !important; text-decoration: none; display: block; text-transform: uppercase;">CONTATO RECEBIDO</span></td>
      ...
      <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
        <tr>
          <td><table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="background-color:#ffffff;">
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner" id="banner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    ...
                    <tr>
                      <td align="center" class="smallfont" style="font:600 23px Open Sans, Arial, Helvetica, sans-serif; color:#16c4a9;">Ol&aacute;, {{ $lead->nome }}</td>
                    </tr>
                    <tr>
                      <td align="center" class="smallfont" style="font:300 18px Open Sans, Arial, Helvetica, sans-serif; color:#999;">recebemos seu contato e logo um de nossos corretores retornar&aacute; o atendimento. Obrigado.</td>
                    </tr>
                    <tr>
                      <td height="20">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                      <td height="68" align="center"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/img/tipo_empreendimento_{{ $lead->empreendimento->subtipo->id }}.png" alt="" width="60" height="60"></td>
                    </tr>
                    <tr>
                      <td height="20" align="center"><span style="font:bold 16px Arial, Helvetica, sans-serif; color:#999; text-transform:uppercase; font-family: Arial, Helvetica, sans-serif; font-size: 16px">{{ $lead->empreendimento->nome }}</span></td>
                    </tr>
                  </table></td>
                  <td width="23" class="sidespace">&nbsp;</td>
                </tr>
            ...
            <tr>
              <td style="border-bottom:1px solid #dbdbdb;"><table width="100%" bgcolor="#00B2B2" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style=" background-image:url(https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/white-bg.gif); background-repeat:repeat-x; background-position:left top;">
                <tr>
                  <td height="23">&nbsp;</td>
                </tr>
                <tr>
                  <td align="center"><img src="https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/mensagem.png" width="83" height="83" alt="picture" /></td>
                </tr>
                <tr>
                  <td height="23">&nbsp;</td>
                </tr>
                <tr>
                  <td height="50" align="center" style="width:100px !important; font:18px Arial, Helvetica, sans-serif; color:#FFFFFF; height:50px !important; text-transform:uppercase; background: #16c4a9; line-height:50px;">
                    <span class="readmore-button">Contato - Portal</span></td>
                </tr>
                <tr>
                  <td height="23">&nbsp;</td>
                </tr>
                <tr>
                  <td height="84" align="center" class="smallfont" style="font:16px Arial, Helvetica, sans-serif; font-style:italic; color:#FFFFFF; padding:0 15px 0 15px;">
                    <p>{{ $lead->mensagem }}</p>
                  </td>
                </tr>
                <tr>
      ...
      <td align="center"><table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
        <tr>
          <td><table width="100%" bgcolor="#00A3D9" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style=" background-image:url(https://www.lancamentosonline.com.br/site/ferramenta/templates_email/images/white-bg.gif); background-repeat:repeat-x; background-position:left top;">
            ...
            <tr>
              <td align="center"><img src="{{ $lead->construtora->getLogoUrl('125x95') }}" width="83" height="83" alt="picture" /></td>
            </tr>
            <tr>
              ...
              <td><table class="inner" align="left" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                <tr>
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <tr>
                      <td height="18" align="center" style="font:12px Helvetica,  Arial, sans-serif; color:#AAA;"><p>{{ $lead->email }}</p>
                        <p>&nbsp;</p></td>
                      </tr>
                    </table></td>
                    <td width="21">&nbsp;</td>
