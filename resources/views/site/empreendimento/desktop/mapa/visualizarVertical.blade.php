...
<head>
  ...
  <style type="text/css">
    ...
    body{
      ...
      .box-select-posicao .icone-posicao{
          width: 50px;
          height: 50px;
          color: #FFF;
          font-size: 40px;
      ...
      .box-select-posicao .select-posicao{
          width: 200px;
          height: 50px;
          padding-left: 10px;
          font-size: 20px;
  ...
  @else
    @if($view <> "pdf")
      <div class="topo-mapa">
        ...
        <div class="box-select-posicao">
          ...
          <select class="select-posicao" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
            <option value="/empreendimento/{{ $empreendimento->id }}/{{ $empreendimento->id*37 }}/visualizar-mapa-vertical/frente" @php if($view == "frente"){echo "selected";} @endphp>FRENTE</option>
            <option value="/empreendimento/{{ $empreendimento->id }}/{{ $empreendimento->id*37 }}/visualizar-mapa-vertical/fundo" @php if($view == "fundo"){echo "selected";} @endphp>FUNDO</option>
            <option value="/empreendimento/{{ $empreendimento->id }}/{{ $empreendimento->id*37 }}/visualizar-mapa-vertical/lateral" @php if($view == "lateral"){echo "selected";} @endphp>LATERAL</option>
          </select>
        </div>
      ...
      <a href="/empreendimento/{{ $empreendimento->id }}/gerarMapa/download-pdf" target="_blank"><button id="btGerarPDF" class="btn-gerar-pdf"></button></a>
